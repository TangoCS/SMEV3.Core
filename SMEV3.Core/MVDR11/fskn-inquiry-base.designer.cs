...
namespace SMEV3.MVDR11
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "urn://x-artefacts-mvd-gov-ru/gunk/inquiry/drug-transportation-permission/1.0.1")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "urn://x-artefacts-mvd-gov-ru/gunk/inquiry/drug-transportation-permission/1.0.1", IsNullable = false)]
    public partial class InquiryResponse : _AttachmentsBlockType
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(InquiryResponse));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current InquiryResponse object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an InquiryResponse object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output InquiryResponse object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out InquiryResponse obj, out System.Exception exception)
        {
            exception = null;
            obj = default(InquiryResponse);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out InquiryResponse obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static InquiryResponse Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((InquiryResponse)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        /// <summary>
        /// Serializes current InquiryResponse object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an InquiryResponse object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output InquiryResponse object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out InquiryResponse obj, out System.Exception exception)
        {
            exception = null;
            obj = default(InquiryResponse);
            try
        ...
        public static bool LoadFromFile(string fileName, out InquiryResponse obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static InquiryResponse LoadFromFile(string fileName)
        {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "urn://x-artefacts-mvd-gov-ru/gunk/inquiry/drug-transportation-permission/1.0.1")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "urn://x-artefacts-mvd-gov-ru/gunk/inquiry/drug-transportation-permission/1.0.1", IsNullable = true)]
    ...
    public partial class _AttachmentDescriptionType
    {
        ...
        private AppliedDocumentType[] appliedDocumentsField;
        ...
        {
            this.appliedDocumentsField = new AppliedDocumentType[0];
        }
        ...
        public AppliedDocumentType[] AppliedDocuments
        {
            get
            {

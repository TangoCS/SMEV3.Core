...
namespace SMEV3.MNPT03
{
	...
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "http://www.minprom.gov.ru/schemas/licensing/Request/1.0.1")]
	[System.Xml.Serialization.XmlRootAttribute(Namespace = "http://www.minprom.gov.ru/schemas/licensing/Request/1.0.1", IsNullable = false)]
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.7.2053.0")]
	[System.SerializableAttribute()]
	[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://www.minprom.gov.ru/schemas/licensing/Request/1.0.1", IncludeInSchema = false)]
	...
	public enum LicenseResponseLicenseLicenseStatus
	{
		...
		/// <remarks/>
		[System.Xml.Serialization.XmlEnumAttribute("Снята с контроля")]
		Снятасконтроля,

...
namespace SMEV3.RZDN01.nspp
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2")]
    [System.Xml.Serialization.XmlRootAttribute("CertificateRequest", Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2", IsNullable = false)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2")]
    [System.Xml.Serialization.XmlRootAttribute("CertificateResponse", Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2", IsNullable = false)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2", IsNullable = true)]
    public partial class CertificateType
    {
        ...
        private OrganizationType[] producerField;
        ...
        {
            this.objectsField = new ObjectType[0];
            this.consigneeField = new OrganizationType();
            this.producerField = new OrganizationType[0];
        ...
        public OrganizationType[] Producer
        {
            get
            {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "urn://smev-roszdravnadzor-ru/NSPP/root/1.0.2", IsNullable = true)]
    public partial class ObjectCollectionType
    {
        ...
        {
            this.objectField = new ObjectType[0];
        }
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ObjectCollectionType));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current ObjectCollectionType object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an ObjectCollectionType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ObjectCollectionType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ObjectCollectionType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(ObjectCollectionType);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out ObjectCollectionType obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static ObjectCollectionType Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((ObjectCollectionType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current ObjectCollectionType object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ObjectCollectionType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ObjectCollectionType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ObjectCollectionType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(ObjectCollectionType);
            try
        ...
        public static bool LoadFromFile(string fileName, out ObjectCollectionType obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static ObjectCollectionType LoadFromFile(string fileName)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
